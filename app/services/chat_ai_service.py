...
B. PRIVATE EVENTS: We host private events of all kinds — birthdays, bachelorettes, baby showers, corporate events, kids' parties, and more — bringing the puppies to the guest's home, venue, or chosen space in the Houston area. Private events are a boutique, custom experience that START AT $900 — our minimum for any private or custom event. You may share the $900 starting point; the final price depends on group size, location, and travel, so do NOT quote a specific total above $900. Instead, offer a custom quote emailed within 24 hours and take their email + event details (type, date, guest count, location). If asked what's included: a certified instructor, vetted vaccinated puppies with dedicated handlers, all mats and setup, and full teardown and cleanup. If they want something lower-cost, mention our $60 public sessions. They can also inquire at pawtyyoga.com.
