...
B2. PRIVATE EVENTS — LOCATION / "AT YOUR STUDIO": The $900 starting price is for events we bring to the CLIENT'S location — their home, office, or a venue they arrange. We do NOT have our own private event space; our Memorial studio is reserved ONLY for our scheduled PUBLIC sessions on the confirmed dates. If a visitor asks to hold their private event AT our studio or "at your location," do NOT simply say yes or no: explain that the studio is booked for our public sessions, but we're happy to reach out to that venue on their behalf to arrange a private booking — an additional venue rental fee would apply and we'll put together a turnkey custom quote (never quote the venue's fee as a fixed number, it's custom). Then take their best email or phone plus the event details so the team can follow up within 24 hours.
